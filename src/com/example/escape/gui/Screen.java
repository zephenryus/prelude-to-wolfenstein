package com.example.escape.gui;
...
//      draw("" + game.player.keys + "/4", 10, height - 26 + 0, 0xffffff);
      draw("Ä", 3, height - 26 + 0, 0xffff00);
      draw("" + game.player.loot, 10, height - 26 + 0, 0xffffff);
      draw("Å", 3, height - 26 + 8, 0xff0000);
      draw("" + game.player.health, 10, height - 26 + 8, 0xffffff);
